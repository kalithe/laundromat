Feature:  Add a washer to the washer table
          
    As a user
    So that I can use a washer in Laundromatters
    I want to add a washer to the washer table
    
Background: a new washer needs to be added to the washer table
  
  Given the following washers have been added
 ...
 And I am on the add washer page
 
Scenario: sort new washers by cycles logged
...
Scenario: sort new washers by date added
...
Scenario: sort new washers by machine number
